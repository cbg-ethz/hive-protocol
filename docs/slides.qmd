...
# Day 1: Foundations {background-color="#2E86AB"}
...
**Goal:** Everyone has a working environment before Day 2.

# Day 2: Bayesian Inference {background-color="#A23B72"}
...
# Day 3: Workflows & Quality {background-color="#F18F01"}
...
|-----|-------|--------------|
| 1 | Foundations | Use pixi + Ruff for 10-100x speedup |
| 2 | Bayesian Inference | Always check diagnostics |
| 3 | Workflows | Automate quality with CI/CD |
