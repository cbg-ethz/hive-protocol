...
# Python at 3am:
car: ToyotaYaris2023 = float(3.14)

# "It's fine, I'll fix the types later"
```

::: {.fragment}
**Night mode:** No guardrails, no warnings, pure chaos.

**Day mode:** Type checkers save you from yourself.
:::
:::

::: {.column width="45%"}
![](images/toyota-yaris-type.png){.center}
:::
::::
