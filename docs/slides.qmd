...
title-slide-attributes:
  data-background-image: images/red-queen.png
  data-background-size: 240px
  data-background-position: 88% 85%
  data-notes: "Red Queen - It takes all the running you can do, to keep in the same place"
format:
  revealjs:
